...
def configId =  'Deployment_Settings'
def configName = 'Maven config for jenkins automated deploymemnt'
def configComment = 'Global Maven Settings'
def configContent  = '''<settings xsi:schemaLocation="http://maven.apache.org/SETTINGS/1.1.0 
